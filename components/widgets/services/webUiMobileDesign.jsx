...
export default function WebUiMobileDesign() {
    return (
        <div className="bg-white">
            <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
                <h2 id="products-heading" className="text-4xl p-4">
                Web And App UI design
                </h2>
                <p className="p-4 text-gray-500 text-2xl">User Interface for User Experience</p>
