...
function AboutPage(props) {
    return (
        <div className=''>
            <div className="relative z-10 bg-gray-900 pb-20 sm:mt-56 sm:pb-24 xl:pb-0">
                    ...
                    <div className="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:px-16 xl:py-24">
                        <figure className="relative isolate pt-6 sm:pt-12">
                            ...
                            <blockquote className="text-xl font-semibold leading-8 text-white sm:text-2xl sm:leading-9">
                                <p>
                                    I am a passionate graphic designer with an
                                    interest in working with like-minded people in both creative
                                    and environments.
                                </p>
                            </blockquote>
                            <figcaption className="mt-8 text-base">
                                ...
                                <div className="mt-1 text-gray-400">
                                    <p className=''>
                                        ...
                                        Freelancer, Communaction Manager
                                        Project Director.
                                    </p>
                                </div>
                            </figcaption>
                ...
                <div className="p-8 md:p-32 lg:p-32 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-5">
                    ...
                    <p className='text-white text-xl'>
                        ...
                        have always worked in tight deadlines in multiple work
                        environments and mostly meet the time-frame. I enjoy
                        working with people including the client in mixing different
                        ideas towards building high quality products.
                    </p>
                    <p className='text-white text-xl'>
                        My key interest is in creation and editing of different computer
                        photographic digital designs and visually appealing design
                        while conforming to purpose-oriented designs creation rules.
                    </p>
                </div>
            </div>
        </div>
